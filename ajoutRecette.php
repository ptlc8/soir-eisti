...
$mysqli->query("INSERT INTO budget (nom, date, valeur, categorie, idUtilisateur) VALUES ('".mysqli_real_escape_string($mysqli, $_POST["nom"])."', '".mysqli_real_escape_string($mysqli, $date)."', '".intval($_POST["prix"])."', '".mysqli_real_escape_string($mysqli, $_POST["categorie"])."', '".$utilisateur["id"]."')");
?>
succes